<?php 
    ...
    $query = "SELECT * FROM book 
              WHERE NOT (category='Programming' OR category ='programming')
              AND NOT (category='Math' OR category='math')
              AND NOT (category='Research' OR category='research')
              AND NOT (category='Science' OR category='science')";
                ...
                <div>
                    ...
                    <div class="nav__list">
                        ...
                        <div class="nav__items">
                            ...
                            <a href="books.php" class="nav__link active">
