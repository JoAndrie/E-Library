...
<!DOCTYPE html>
    ...
    <head>
        ...
        <!--========== CSS ==========-->
        <link rel="stylesheet" href="css/add_authors.css">

        <title>AthenaIntAdmin: Update Authors</title>
    ...
    <body>
        ...
        <main>
 <div class="container">
    <div class="title">Update Author</div>
    <div class="content">
      <form action="functions/update_authors.php?ID=<?php echo $ID ?>" method="post">
        <div class="user-details">
          <div class="input-box">
            <span class="details">Author Name</span>
            <input type="text" required name ="Author" value="<?php echo $Author ?>">
          </div>
        <div class="button">
          <input type="submit" name="update" onclick="return confirm('Do you want to edit data?')">
        </div>
      </form>
    </div>
  </div>
