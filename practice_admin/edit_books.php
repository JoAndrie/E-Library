...
<!DOCTYPE html>
 ...
 <div class="container">
    ...
    <div class="content">
      <form action="https://localhost/test/update_books.php?ID=<?php echo $ID ?>" method="post" enctype="multipart/form-data">
        <div class="user-details">
          <div class="input-box">
            <span class="details">Book Name</span>
            <input type="text" required name="book" value="<?php echo $book ?>">
          </div>
          <div class="input-box">
          ...
          <div class="input-box">
            ...
            <input type="text" required name="category" value="<?php echo $category ?>">
          </div>
