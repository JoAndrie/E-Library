<?php 
    ...
    $query = "SELECT ID, author, creation, updated FROM author";
...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title>AthenaIntAdmin: Authors</title>
    ...
    <body>
        ...
        <div class="table_header">
            <p>Manage Authors</p>
            <form action="search_authors.php" method="post">
                <div class="author_search"> <input placeholder="author" type="text" name="search">
        ...
        <div class="table_section">
            <table>
                ...
                <tbody>
                    ...
                    <td><?php echo $ID ?></td>
                    <td><?php echo $Author ?>
                    <td><?php echo $Creation ?>
                    <td><?php echo $Updated ?>
                    <td><button><a href="edit_authors.php?GetID=<?php echo $ID ?>"> <i class="fa-solid fa-pen-to-square"></i></button> 
                        <button><a href="functions/delete_authors.php?Del=<?php echo $ID ?>" onclick="return confirm('Do you want to delete data?')"><i class="fa-solid fa-trash"></i></button>
                </tbody>
                     <?php 
                         }  
                    ?>    
