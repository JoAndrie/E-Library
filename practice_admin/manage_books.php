...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title>AthenaIntAdmin: Book</title>
    ...
    <body>
        ...
        <div class="table_header">
            ...
            <form action="search_books.php" method="post">
                <div class="author_search"> <input placeholder="books" type="text" name="search"/>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td><button><a href="edit_books.php?GetID=<?php echo $ID ?>"><i class="fa-solid fa-pen-to-square"></i></button></a>
                            <button><a href="functions/delete_books.php?Del=<?php echo $ID ?>" onclick="return confirm('Do you want to delete data?')"><i class="fa-solid fa-trash"></i></button></a>
                    </tbody>
                         <?php 
                             }  
                        ?>    
