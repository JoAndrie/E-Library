<?php 
    ...
    $query = "SELECT ID, subject, creation, updated FROM subject";
...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title>AthenaIntAdmin: Subject</title>
    ...
    <body>
        ...
        <div class="table_header">
            ...
            <form action = "search_subject.php" method="post">
                <div class="author_search"> <input placeholder="subjects" type="text" name="search"/> 
        ...
        <div class="table_section">
            <table>
                ...
                <tbody>
                   ...
                   <td><?php echo $Updated ?>
                   <td><button><a href="edit_subject.php?GetID=<?php echo $ID ?>"><i class="fa-solid fa-pen-to-square"></i></button> 
                       <button><a href="functions/delete_subject.php?Del=<?php echo $ID ?>" onclick="return confirm('Do you want to delete data?')"><i class="fa-solid fa-trash"></i></button>
               </tbody>
                    <?php 
                        }  
                   ?>    
