...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title>AthenaIntAdmin: Dashboard</title>
    ...
    <body>
                ...
                <div>
                    ...
                    <div class="nav__list">
                        <div class="nav__items">
                            ...
                            <a href="practice_admin.php" class="nav__link active">
        ...
        <main>
            <section class="dashbox">
                <h2>Admin Dashboard</h2> <h2>Welcome <?php echo $_SESSION["name"] ?></h2>
            <div class="dash-container">
                <a href="manage_books.php">
                <article class="dashboard">
                            <i class='bx bx-book dash-icon'></i>
                ...
                <article class="dashboard">
                            <i class='bx bxs-book-content dash-icon'></i>
                        <div class="dash-title">
                        <h4>Subjects</h4>
                        </div>
                </article>
                ...
                <article class="dashboard">
                            <i class='bx bx-user-pin dash-icon'></i>
                        <div class="dash-title">
                        <h4>Authors</h4>
                        </div>
                </article>
                ...
                <article class="dashboard">
                            <i class='bx bx-copy-alt dash-icon'></i>
                        <div class="dash-title">
                        <h4>Submission</h4>
                        </div>
                </article>
