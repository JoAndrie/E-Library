<?php 
    ...
    if(count($_POST)>0) {
        $search = $_POST['search'];
        $query = "SELECT * FROM book WHERE book LIKE '$search%'";
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td><?php echo $author ?>
                        <td><button><a href="edit_books.php?GetID=<?php echo $ID ?>"><i class="fa-solid fa-pen-to-square"></i></button> 
                            <button><a href="functions/delete_books.php?Del=<?php echo $ID ?>" onclick="return confirm('Do you want to delete data?')"><i class="fa-solid fa-trash"></i></button>
                    </tbody>
                         <?php 
                             }  
                        ?>    
