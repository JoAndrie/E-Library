<?php 
    ...
    if(count($_POST)>0) {
        $search = $_POST['search'];
        $query = "SELECT * FROM pending WHERE book LIKE '$search%'";
            ...
            <table>
                ...
                <tr>
                    <?php                       
                        ...
                        <td><button><a href="functions/approve.php?GetID=<?php echo $ID ?>" onclick="return confirm('Do you want to approve book?')"><i class="fa-solid fa-pen-to-square"></i></button> 
